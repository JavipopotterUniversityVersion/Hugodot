...
func test():
	...
	final const_untyped_array: Variant = []
	...
	final const_int_array: Variant = [] as Array[int]
	...
	final const_b_array: Variant = [] as Array[B]
